# Age distributions
# https://cran.r-project.org/web/packages/httk/vignettes/supplemental_vignette_age_dist.html
...
# nhanes_mec_svy: Pre-processed NHANES data. (https://rdrr.io/cran/httk/man/nhanes_mec_svy.html)

all.reth <- levels(nhanes_mec_svy$variables[, ridreth1])
all.gendr <- levels(nhanes_mec_svy$variables[, riagendr])

# Get smoothed density estimates for age in months, by cycle for each gender and race/ethnicity, 
# using the survey::svysmooth function.
